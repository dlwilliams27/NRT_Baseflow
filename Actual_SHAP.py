...
path=r"C:\Users\Delanie Williams\OneDrive - The University of Alabama\Research\Baseflow Project\Camels_Stats_Combined.csv"
data=pd.read_csv(path)

#setting-up input and output datasets
inputs=data.iloc[:,5:]
outputs=data.iloc[:,1:5]
inputs['gage']=data['gage']
outputs['gage']=data['gage']
outputs['gage']=outputs['gage'].astype(str).str.zfill(8)
inputs['gage']=inputs['gage'].astype(str).str.zfill(8)
